...
def parse_dtype(dtype_str: str) -> mx.Dtype:
    ...
    if dtype_str not in dtype_map:
        raise ValueError(f"Unsupported dtype: {dtype_str}. Supported dtypes: {list(dtype_map.keys())}")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        nargs="+", 
        default=[],
        help="List of initial DHT peers"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Public IP address to announce"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Port for DHT communication"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="URL to notify when a request is finished"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        required=True,
        help="Ending layer index for this shard (exclusive)"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=16,
        help="Block size for KV cache management"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help="Micro batch ratio for scheduling"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=500,
        help="Scheduler wait time in milliseconds"
    )
